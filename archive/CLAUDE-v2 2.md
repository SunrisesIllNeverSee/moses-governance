...
├── contexts/
│   ├── high-security.md     ← High Security mode context
│   ├── research.md          ← Research mode context
│   ├── creative.md          ← Creative mode context
│   └── defense.md           ← Defense posture context
├── rules/
│   └── governance.md        ← Always-follow constitutional rules
├── kassa/
